...
contract("Token Test", function(accounts) {
    ...
    it("I can send tokens from Account 1 to Account 2", async () => {
        ...
        return expect(instance.balanceOf(initialHolder)).to.eventually.be.a.bignumber.equal(totalSupply.sub(new BN(sendTokens))); await expect(instance.balanceOf(recipient)).to.eventually.be.a.bignumber.equal(new BN(sendTokens));
    });
